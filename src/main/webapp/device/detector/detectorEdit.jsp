	...
	<script>
		$(function() {
			...
			$.ajax( {
			    ...
			    data:{
			    	'sqlId':'alarm-detector-getDetectorById',
			    ...
			    success:function(data) {
			    	if(data!=null && data.length > 0){
			    		var detectorObj = data[0];
			    		$("#detectorSeq").textbox('setValue', detectorObj.detector_seq);
			    		$("#nfcNumber").textbox('setValue', detectorObj.nfc_number);
			    		$('#longitude').textbox('setValue', detectorObj.longitude);
			    		$("#latitude").textbox('setValue', detectorObj.latitude);
			    		$("#posDesc").textbox('setValue', detectorObj.pos_desc);
